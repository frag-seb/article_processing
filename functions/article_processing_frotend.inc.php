...
{       		
	...
	if ($frontend_on == "1") 
	{
				...
				$bearbeiten .=  " ".$style_div;
				$bearbeiten .=  rex_get_file_contents($REX['INCLUDE_PATH'].'/addons/article_processing/files/frontend.css');
				
				$bearbeiten .=  "</style>";
				
				$bearbeiten	.=	"<div id=\"article_processing\">";
	// Artikel Bearbeitung		
